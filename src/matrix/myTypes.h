...
enum MATRIX_MASK_ONE_SCALAR_OPERATIONS
{
	...
	MASK_ONE_SCALAR_ADD = 1,
	MASK_ONE_SCALAR_SUB_MLEFT = 2,
	MASK_ONE_SCALAR_SUB_MRIGHT = 3,
	MASK_ONE_SCALAR_MUL = 4,
	MASK_ONE_SCALAR_DIV_MLEFT = 5,
	MASK_ONE_SCALAR_DIV_MRIGHT = 6
};